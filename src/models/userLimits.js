...
const PLANS = {
  FREE: {
    ...
    description: '3 проверки договоров навсегда. Все функции анализа доступны.',
    features: [
      '3 проверки договоров навсегда'
    ]
  },
  BASIC: {
    id: 'BASIC',
    ...
    requestLimit: 10,
    duration: 30, // 30 дней
    description: '10 проверок договоров в месяц. Все функции анализа доступны.',
    features: [
  ...
  PRO: {
    ...
    requestLimit: 50,
    duration: 30, // 30 дней
    description: '50 проверок договоров в месяц. Все функции анализа доступны.',
    features: [
  ...
  UNLIMITED: {
    ...
    duration: 30, // 30 дней
    description: 'Неограниченное количество проверок договоров в месяц. Все функции анализа доступны.',
    features: [
